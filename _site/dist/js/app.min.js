...
var mainHeader=$(".main-header"),headerHeight=mainHeader.outerHeight(),sections=["main"];window.sr=ScrollReveal({reset:!0}),$.each(sections,function(e,n){sr.reveal(n,{duration:1e3,origin:"left",scale:1})}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}});