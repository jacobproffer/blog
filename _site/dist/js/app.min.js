...
var mainHeader=document.querySelector(".main-header"),headerHeight=mainHeader.offsetHeight,headroom=new Headroom(mainHeader,{offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.classList.contains("open")&&mainHeader.classList.remove("unpinned")},onTop:function(){mainHeader.classList.remove("pinned")}});headroom.init(),console.log("JavaScript is working");